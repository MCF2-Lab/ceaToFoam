...
import CEAtoFOAM
from CEAtoFOAM import gammas, Ae_At, Rt

#CREDIT: https://github.com/ravi4ram/Bell-Nozzle/tree/master
"""
...
def bell_nozzle(k, aratio, Rt, l_percent):
	...
	entrant_angle  	= -135 #this then will translate to a converging angle of 45 degrees
...
#-----------------------------------------------------------------------
	#addng this section so that the points generated from the geometric functions can be inputted in Solidworks 
	list_points = (x,y,z)
	print("x\t\ty")
    ...
    # Write to CSV file
		import csv
		with open("nozzle_points.csv", "w", newline="") as csvfile:
...
if __name__=="__main__":
	...
	# constants
	k 	= gammas		# ratio of specific heats
	l_percent = 80	# 80 percent bell nozzle design as prescribed in Modern Engineering for Design of Liquid-Propellant Rocket Engines by Huzel and Huang
